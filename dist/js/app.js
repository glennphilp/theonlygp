...
function drawInProgress() {
  var data = google.visualization.arrayToDataTable([['Task', 'Hours per Day'], ['Complete', 77], ['Remaining', 43]]);
...
function drawCompleted() {
  var data = google.visualization.arrayToDataTable([['Task', 'Hours per Day'], ['Complete', 100]]);
